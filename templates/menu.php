      ...
      <nav class="u-menu u-menu-dropdown u-offcanvas u-menu-1">
        ...
        <div class="u-custom-menu u-nav-container">
          <ul class="u-nav u-unstyled u-nav-1">
            ...
            <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="./app/vista/listaBonsais.php" style="padding: 10px 20px;">Ver Bonsais</a></li>
            ...
            <li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="./app/controlador/logout.php" style="padding: 10px 20px;">Cerrar Sesión</a></li>
          ...
          <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
            <div class="u-sidenav-overflow">
              ...
              <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                ...
                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="./app/controlador/logout.php" style="padding: 10px 20px;">Cerrar Sesión</a></li>
              </ul>
            </div>
          </div>
